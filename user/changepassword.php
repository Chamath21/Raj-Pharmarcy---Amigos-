...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Raj Pharmarcy | Change Password</title>
        <!-- App css -->
...
<div class="form-group row">
<div class="col-12">
<p style="text-align: center;">   <button type="submit" name="submit" class="btn btn-info btn-min-width mr-1 mb-1">Change Password</button></p>
</div>
</div>
