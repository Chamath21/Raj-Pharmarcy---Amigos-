...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>RAJ Pharmarcies | Terms & Conditions</title>
        <!-- App css -->
                        ...
                        <div class="card-box p-5">
                            <h3 class="text-uppercase text-center pb-4">
                                <a href="index.html" class="text-success">
                                    <span>RAJ Pharmarcies | Terms & Conditions</span>
                                </a>
                            </h3>
                            <hr />
...
<h5>Welcome to RAJ Pharmarcy!</h5>
...
<p>Colombo</p>
            ...
            <div class="m-t-40 text-center">
                <p class="account-copyright">© RAJ Pharmarcies</p>
            </div>
