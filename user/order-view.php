...
<script type="text/javascript">
  function printdata()
  {
    ...
    <body>
		...
		<div class="accountbg" style="background: url('../assets/images/order-view.jpg');background-size: cover;background-position: center;"></div>
...
$uid=$_SESSION['sid'];
$ret=mysqli_query($con,"select * from tblorderrequest where ID='$cid' and UserId='$uid'");
$cnt=1;
