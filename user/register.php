...
if(isset($_POST['submit']))
  {
    ...
    if($result>0){
$msg="This email or Contact Number is already been used in another account";
    }
    else{
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>RAJ Pharmacy | Sign up</title>
        <!-- App css -->
                    ...
                    <div class="account-box">
                        ...
                        <div class="card-box p-5">
                            <h3 class="text-uppercase text-center pb-4">
                                <a href="../index.php">
                                    <span>RAJ PHARMARCY | CUSTOMER REGISTRATION</span>
                                </a>
                            </h3>
                              <hr color="#000" />
    ...
    echo $msg;
                            ...
                            <form class="form-horizontal" action="" name="signup" method="post" onsubmit="return checkpass();">
                                ...
                                <div class="form-group row m-b-20">
                                 ...
                                 <div class="form-group row m-b-20">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" type="password" required="" id="repeatpassword" name="repeatpassword" placeholder="Confirm your password">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row text-center m-t-10">
                                    <div class="col-12">
                                        <button class="btn btn-block btn-custom waves-effect waves-light" type="submit" name="submit">Register</button>
                                    </div>
                                </div>
                            ...
                            <div class="row m-t-50">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted">Already have an account?  <a href="index.php" class="text-dark m-l-5"><b>Log In</b></a></p>
                                </div>
                            </div>

                            <div class="m-t-40 text-center">
                <p class="account-copyright"> © Amigos - Online Ordering System</p>
            </div>
                        </div>
                    </div>
