...
if(isset($_POST['submit']))
  {
    $uid=$_SESSION['sid'];
     ...
     $query=mysqli_query($con,"insert into tblservicerequest(UserId,Category,OrderDetails,PatientAge,PatientAddress,PatientContno,DpDate,DpTime,Branch) value('$uid','$category','$sernumber','$orderdetails','$age','$address','$connumber','$odate','$otime','$branchname')");
    if ($query) {
              ...
              <option value="<?php echo $row['Ocategory'];?>"><?php echo $row['Ocategory'];?></option>
                  <?php } ?>  
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <input type="text" id="orderdetails" name="orderdetails" class="form-control" placeholder="Order Details" required="true" pattern="[A-Za-z]+" title="This field can only contain A-Z letters">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                 ...
                                                 <div class="form-group row">
                                                        ...
                                                        <div class="col-10">
                                                            <select name="deltype" id="branch" required="true" class="form-control">
                                                                <option value="">Select</option>
                                                                 <option value="pickupservice">Colombo</option> 
 <option value="dropservice">Bambalapitiya</option> 
                                                            </select>
                                                        </div>
                                                    </div>
