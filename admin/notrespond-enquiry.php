...
<html lang="en">
    ...
    <body>
		...
		<div class="accountbg" style="background: url('../assets/images/16.jpg');background-size: cover;background-position: center;"></div>
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title">Not Responded Enquiries</h4>
